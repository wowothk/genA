...
#        maks_od=2
#        print(Od)
#        print(len(Od),len(capacityW), tot_cap,tot_dem)
...
#v3 = [1,1,3,3,3]
##print(d)
#stg_3 = stage_3(dc, customer, W, d, [2,2,3,3,4]).decode()
#print(stg_3)
